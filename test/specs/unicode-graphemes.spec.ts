...
test.describe('ContentEditable - Grapheme Clusters & Unicode', () => {
  ...
  test('deletes entire grapheme clusters', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
  ...
  test('handles flag emoji sequences', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
  ...
  test('handles variation selectors', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
  ...
  test('handles Indic script conjuncts', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
  ...
  test('handles Arabic text shaping', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
  ...
  test('handles surrogate pairs', async ({ page }) => {
    const editor = page.locator('[role="textbox"]').first()
    await selectAndClear(page, editor)
